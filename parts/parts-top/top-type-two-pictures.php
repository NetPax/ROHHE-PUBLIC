<section class="top <?php echo $top_type_class; ?>">
	...
	<div class="container">
		<div class="top-wrapper">
			...
			<?php endif; ?>
			<?php if ($top_type === 'top_type_two_pictures'): ?>
				<?php if ($top_image): ?>
					<?php echo wp_get_attachment_image($top_image['ID'], 'fullhd', false, [ 'class' => 'top-image' ]); ?>
				<?php endif; ?>

				<?php $top_image_2 = get_field('top_image_2'); ?>
				<?php if ($top_image_2): ?>
					<?php echo wp_get_attachment_image($top_image_2['ID'], 'fullhd', false, [ 'class' => 'top-image-2' ]); ?>
				<?php endif; ?>
			<?php endif; ?>
		</div>
	</div>
